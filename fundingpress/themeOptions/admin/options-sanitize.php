...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__('Top Left', 'fundingpress'),
		'top center'    => esc_html__('Top Center', 'fundingpress'),
		'top right'     => esc_html__('Top Right', 'fundingpress'),
		'center left'   => esc_html__('Middle Left', 'fundingpress'),
		'center center' => esc_html__('Middle Center', 'fundingpress'),
		'center right'  => esc_html__('Middle Right', 'fundingpress'),
		'bottom left'   => esc_html__('Bottom Left', 'fundingpress'),
		'bottom center' => esc_html__('Bottom Center', 'fundingpress'),
		'bottom right'  => esc_html__('Bottom Right', 'fundingpress')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__('Scroll Normally','fundingpress'),
		'fixed'  => esc_html__('Fixed in Place','fundingpress')
		);
