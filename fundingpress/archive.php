                ...
                $funding_allowed['iframe'] = array(
                 ...
                 echo wp_kses($key_1_value, $funding_allowed,array('http', 'https'));
                  ...
                  <a href="<?php the_permalink(); ?>">  <?php
                            ...
                            $image = aq_resize( $img_url, 817, 310, true ); //resize & crop img
                            ?>
                            <img class="attachment-small wp-post-image" src="<?php echo esc_url($image); ?>" /></a>
             <?php } ?>
...
<div class="clear"></div>
            ...
            <div class="blog-pinfo-wrapper">
                <div class="post-pinfo"><?php esc_html_e("By", 'fundingpress'); ?>
                    <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta( 'ID' ))); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e("View all posts by", 'fundingpress');?> <?php echo get_the_author(); ?>"><?php echo get_the_author(); ?></a> |
